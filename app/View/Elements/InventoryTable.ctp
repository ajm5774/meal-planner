...
$form .= $this->Form->input('Ingredient.id', array('rel' => '0', 'div' => false)) . '<br>';
$form .= $this->Form->input('Ingredient.name', array('rel' => '1', 'div' => false, 'options' => $ingredients)) . '<br>';
$form .= $this->Form->input('Inventory.quantity', array('rel' => '2', 'div' => false)) . '<br>';
$form .= $this->Form->input('Inventory.unit', array('rel' => '3', 'div' => false)) . '<br>';
$form .= $this->Form->end();
$element .= $form;
...
$(document).ready( function () {
    $('#invTable').dataTable().makeEditable({sUpdateURL: "/Inventories/edit"});
} );
